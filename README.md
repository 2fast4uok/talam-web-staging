Tālam's website
Based on [Next.js starter template](https://github.com/timlrx/tailwind-nextjs-starter-blog)
...
`data/authors` - contains information about blog post authors.

`data/headerNavLinks.js` - navigation links.

`data/logo.svg` - Tālam logo shown in the navbar.

`data/blog` - add blog posts as mdx files here
